...
token= "6906785531:AAEQGhY58tW-0-Hlm91vUbCJoOz3TDvpQ-8"
...
def create():
 ...
 tlg = f''' تم صيد زنجي  جديد
كن ما شئت فقط لا تكن زنجي 
⋘─────━━─────⋙
˛ U𝗌𝖾𝗋  : {user}
˛ 𝖯𝖺𝗌𝗌𝗐𝗈𝗋𝖽 : hhhh
⋘─────━━─────⋙
...
executor=concurrent.futures.ThreadPoolExecutor(max_workers=900)
